...
export const StatisticsOpportunities: FC = () => {
  ...
  const breadcrumb = [
    {
      id: 1,
      title: t("statistics-opportunities"),
    },
    {
      id: 2,
      title: (
  ...
  const data = [
    ...
    },
    {
      id: 2,
      status: "delete",
      razdel_name: "Коммунальные услуги",
      date: "01.01.2022 00:00:00",
    },
    {
      id: 2,
      status: "create",
      razdel_name: "Номера и коды",
      date: "01.01.2022 00:00:00",
    },
  ];
